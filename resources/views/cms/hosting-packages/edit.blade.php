...
<head>
    ...
    <title>Edit Paket Hosting - AbahWeb CMS</title>
...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4 mb-4">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-gray-900">Edit Paket Hosting</h2>
                    <p class="mt-2 text-gray-600">Edit informasi paket hosting "{{ $package->name }}"</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <form method="POST" action="{{ route('cms.hosting-packages.update', $package->id) }}" x-data="packageForm()">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <select id="badge" name="badge" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                ...
                                <option value="Popular" {{ old('badge', $package->badge) === 'Popular' ? 'selected' : '' }}>Popular</option>
                                <option value="Recommended" {{ old('badge', $package->badge) === 'Recommended' ? 'selected' : '' }}>Recommended</option>
                                <option value="Best Value" {{ old('badge', $package->badge) === 'Best Value' ? 'selected' : '' }}>Best Value</option>
                            </select>
                        </div>
    ...
    <script>
        function packageForm() {
            return {
                features: @json(old('features', $package->features ?? [''])),
