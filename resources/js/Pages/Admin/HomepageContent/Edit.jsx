...
export default function Edit({ auth, content }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        sort_order: content.sort_order || 1,
    ...
    useEffect(() => {
        ...
        const fields = Object.entries(data.metadata).map(([key, value]) => ({ key, value }));
        if (fields.length === 0) {
    ...
    const handleSubmit = (e) => {
        ...
        const formData = { ...data, metadata: metadataObj };
        put(route('admin.homepage-content.update', content.id), {
            data: formData
        });
    };
